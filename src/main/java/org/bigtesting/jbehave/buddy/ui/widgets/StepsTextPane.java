...
/**
 * Derived from http://tips4java.wordpress.com/2009/05/23/text-component-line-number/
 * <p>
...
public class StepsTextPane extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener {
	...
	/*
	 * Indicates whether this Font should be
	 * updated automatically when the Font of the related text component
	 * is changed.
	 *
	 * When true update the Font and repaint the line
